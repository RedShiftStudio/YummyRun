...
| Экран | Изображение |
|-------|-------------|
| **Страница регистрации** | <img src="screenshots/registration.png" alt="Регистрация" width="300" /> |
| **Страница авторизации** | <img src="screenshots/login.png" alt="Авторизация" width="300" /> |
| **Модальное окно для восстановления пароля** | <img src="screenshots/forget_password.png" alt="Восстановление пароля" width="300" /> |
| **Главный экран** | <img src="screenshots/home.png" alt="Главная" width="300" /> |
| **Детали товара** | <img src="screenshots/food_details.png" alt="Детали товара" width="300" /> |
| **Добавление товара в корзину** | <img src="screenshots/modal_add_to_cart.png" alt="Добавление в корзину" width="300" /> |
| **Корзина** | <img src="screenshots/cart.png" alt="Корзина" width="300" /> |
| **Аккаунт** | <img src="screenshots/account.png" alt="Аккаунт" width="300" /> |
